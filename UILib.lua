...
function library:CreateSettingsTab(menu)
    ...
    end}):AddButton({text = 'Save', confirm = false, callback = function()
    ...
    configSection:AddButton({text = 'Create', confirm = false, callback = function()
        ...
        refreshConfigs()
    end}):AddButton({text = 'Delete', confirm = false, callback = function()
    ...
    mainSection:AddButton({text = "Unload", confirm = false,
    ...
    mainSection:AddSlider({text = 'Custom X', flag = 'watermark_x', suffix = '%', min = 0, max = 100, increment = .1, value = 72.3});
    mainSection:AddSlider({text = 'Custom Y', flag = 'watermark_y', suffix = '%', min = 0, max = 100, increment = .1, value = 1.5});
    ...
    mainSection:AddSlider({text = 'Position X', flag = 'keybind_indicator_x', min = 0, max = 100, increment = .1, value = 92.2, callback = function()
    ...
    mainSection:AddSlider({text = 'Position Y', flag = 'keybind_indicator_y', min = 0, max = 100, increment = .1, value = 1.5, callback = function()
        library.keyIndicator:SetPosition(newUDim2(library.flags.keybind_indicator_x / 100, 0, library.flags.keybind_indicator_y / 100, 0));    
    end});

...
get("player").update = function(self, character, data)
	...
	task.spawn(function()
		...
		if visible and check() then
			...
			drawings.weapon.Position = visuals.weapon.enabled and Vector2.new(drawings.distance.Position.x, drawings.distance.Position.Y + drawings.distance.TextBounds.Y + 2) or drawings.distance.Position
